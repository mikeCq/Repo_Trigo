...
Public Class GeneraContrato
    ...
    Private Sub TEST()
        ...
        da.Fill(ds, "tabla")
        text01 = ds.Tables("tabla").Rows(0).Item(0)
    End Sub
    ...
    Private Sub CreateMailMergeDataFile()
        ...
        Next iCount
        ' Fill in the data.
        FillRow(wrdDataDoc, 2, "WALL FARMS SPR DE RL DE CV", "33-B", "804105012", "80", "WAF290990", "")
    ...
    Public Sub GeneraContrato1()
        ...
        StrToAdd = "POR MEDIO DE LA PRESENTE SOLICITUD " & "NOMBRE DE PRODUCTOR " & "MEDIANTE SU APODERADO LEGAL" &
            "NOMBRE DE APODERADO LEGAL" & ", SOLICITA SER ACEPTADO COMO ASOCIADO DE LA PERSONA MORAL " & "EMPRESA" &
            ...
            "APODERADO DE EMPRESA" & ", APODERADO LEGAL DE LA SOCIEDAD DENOMINADA, " & "EMPRESA" & ", Y " & "NOMBRE DE PRODUCTOR" & " POR MEDIO DEL PRESENTE, CONFIRMA QUE SU ACUERDO DE REALIZAR CUALQUIERA DE LOS SIGUIENTES ESQUEMAS DE PRODUCCIÓN: " &
            ...
            "NOMBRE DE PRODUCTOR" & " MANIFIESTAN QUE ES SU VOLUNTAD SOBRE LA PRODUCCIÓN LIBRE."
